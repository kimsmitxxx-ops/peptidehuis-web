...
export const metadata: Metadata = {
  title: "Privacyverklaring — peptidehuis",
  description:
    "Hoe peptidehuis persoonsgegevens verwerkt, opslaat en beschermt onder de AVG. Lees welke data we vastleggen en hoe lang.",
};
...
const sections = [
  {
    ...
    body: [
      "peptidehuis B.V., gevestigd aan de Westhavenkade 12, 3134 NA Vlaardingen, is verwerkingsverantwoordelijke voor de gegevens die via peptidehuis.nl worden verzameld. Ons KvK- en BTW-nummer staan op de factuur die je na je bestelling ontvangt.",
    ],
  },
  {
    id: "welke",
