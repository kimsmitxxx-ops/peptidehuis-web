...
const blocks = [
  {
    ...
    sources: "Bron: Liu et al, Chin Med J 2019 (PMID 31478927) — AAS en cardiovasculair risico.",
  },
  {
    icon: Activity,
    ...
    sources: "Bron: Rahnema et al, Fertil Steril 2014 (PMID 24636400) — AAS-geïnduceerde hypogonadisme.",
  },
  {
    icon: FlaskConical,
    ...
    sources: "Bron: Petrovic et al, World J Gastroenterol 2022 (PMID 36051334) — AAS-geïnduceerde lever-schade.",
  },
  {
    icon: Brain,
    ...
    sources: "Bron: Piacentino et al, Curr Neuropharmacol 2015 (PMID 26074746) — AAS en psychopathologie.",
  },
  {
    icon: AlertTriangle,
    ...
    sources: "Bron: Kanakis et al, Andrology 2019 (PMID 31099174) — EAA clinical practice guidelines gynecomastie.",
  },
  {
    icon: ShieldAlert,
