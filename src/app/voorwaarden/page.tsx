...
export const metadata: Metadata = {
  title: "Algemene voorwaarden — peptidehuis",
  description:
    "De algemene voorwaarden van peptidehuis B.V.: bestelproces, betaling, levering, garantie, aansprakelijkheid en herroepingsrecht.",
};
...
const sections: { id: string; title: string; body: string[] }[] = [
  {
    ...
    title: "1. Definities",
    body: [
      "peptidehuis: peptidehuis B.V., gevestigd te Westhavenkade 12, 3134 NA Vlaardingen. Ons KvK- en BTW-nummer staan op de factuur die je na bestelling ontvangt.",
      "Klant: de natuurlijke of rechtspersoon die een overeenkomst aangaat met peptidehuis.",
      "Producten: alle door peptidehuis aangeboden artikelen, uitsluitend bestemd voor onderzoeksdoeleinden in een laboratoriumomgeving en niet voor menselijke consumptie.",
    ],
  },
  {
    id: "toepasselijkheid",
    ...
    body: [
      "Deze voorwaarden zijn van toepassing op elk aanbod van peptidehuis en op elke tot stand gekomen overeenkomst tussen peptidehuis en klant.",
  ...
  },
  {
    ...
    body: [
      ...
      "Kennelijke vergissingen of fouten in het aanbod binden peptidehuis niet.",
    ],
  },
  {
    id: "overeenkomst",
    ...
    body: [
      "De overeenkomst komt tot stand op het moment dat de klant het aanbod heeft aanvaard via een bestelling en de betaling door peptidehuis is bevestigd.",
      "peptidehuis kan zich binnen wettelijke kaders op de hoogte stellen of de klant aan zijn betalingsverplichtingen kan voldoen.",
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      "peptidehuis behoudt zich het recht voor prijzen te wijzigen; eenmaal geplaatste orders blijven ongewijzigd.",
    ],
  },
  {
    id: "levering",
    title: "7. Levering",
    body: [
      "peptidehuis neemt de grootst mogelijke zorgvuldigheid in acht bij ontvangst en uitvoering van bestellingen.",
  ...
  },
  {
    ...
    body: [
      "peptidehuis staat ervoor in dat elk product voldoet aan de specificaties zoals weergegeven op het Certificate of Analysis (COA) van de bijbehorende batch.",
      "Wijkt het werkelijke gehalte, vastgesteld door een onafhankelijk laboratorium, meer dan 5% af van het opgegeven COA, dan vervangt peptidehuis het product kosteloos in de volgende zending.",
    ],
  },
  {
    ...
    body: [
      "Producten van peptidehuis zijn uitsluitend bestemd voor onderzoeksdoeleinden in een laboratoriumomgeving en niet voor menselijke of dierlijke consumptie.",
      "De klant is volledig zelf verantwoordelijk voor het gebruik en de toepassing van de geleverde producten.",
      "peptidehuis aanvaardt geen aansprakelijkheid voor schade, direct of indirect, voortvloeiend uit een ander gebruik dan het hierboven omschreven doel.",
    ],
  },
  {
    id: "klachten",
    ...
    body: [
      "Klachten over de uitvoering van de overeenkomst dienen binnen redelijke termijn, volledig en duidelijk omschreven, te worden ingediend bij peptidehuis via het contactformulier op de website.",
      "peptidehuis reageert binnen 14 dagen na ontvangst van de klacht met een inhoudelijke reactie of een indicatie van de termijn waarop dat gebeurt.",
      "Komen klant en peptidehuis er onderling niet uit, dan kan het geschil worden voorgelegd aan de bevoegde rechter te Rotterdam.",
    ],
  },
  {
    ...
    body: [
      "Op overeenkomsten tussen peptidehuis en klant is uitsluitend Nederlands recht van toepassing.",
    ],
  },
];
...
export default function VoorwaardenPage() {
  return (
    <>
      <PageHero
        eyebrow="Juridisch"
        title="Algemene voorwaarden peptidehuis B.V."
