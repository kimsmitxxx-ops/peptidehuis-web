...
export const categoryContent: CategoryContent[] = [
    ...
    sections: [
      {
        ...
        body: "<p>Testosteron is het primaire mannelijke geslachtshormoon dat bindt aan de androgeen-receptor in spier-, bot- en hersenweefsel.</p>\n\n<p>Het pusht eiwitsynthese, stikstofretentie en de aanmaak van rode bloedcellen. Vandaar dat je harder traint en sneller herstelt.</p>\n\n<ul>\n  <li>Een deel wordt via aromatase omgezet in oestradiol, vandaar potentiële gyno en vochtretentie.</li>\n  <li>Een deel wordt via 5α-reductase in DHT omgezet: acne, eventueel haaruitval bij genetische gevoeligheid.</li>\n</ul>\n\n<p>Exogeen testosteron schakelt je natuurlijke LH/FSH-as uit binnen 1-2 weken. Dat is de reden dat een PCT na de kuur noodzakelijk is.</p>",
      },
      {
        heading: "Doseringen en cycle-protocol",
        body: "<p>Beginners draaien 12-16 weken Test E op 400-500 mg/week, gesplitst in 2 prikken (maandag/donderdag) om bloedwaarden stabiel te houden.</p>\n\n<p>Intermediates schuiven richting 500-750 mg/week en stacken vaak met een 19-nor of DHT-derivaat.</p>\n\n<p>Een TRT-cruise tussen blasts ligt op 150-200 mg/week.</p>\n\n<p>Sustanon 250 prik je idealiter ook 2x per week ondanks de marketing van 'eens per week' — anders krijg je bloedwaarde-pieken.</p>\n\n<p>Eerste bloedwerk op <strong>week 6</strong>:</p>\n<ul>\n  <li>totaal test</li>\n  <li>vrij test</li>\n  <li>E2 (sensitive assay)</li>\n  <li>bloeddikte (hematocriet)</li>\n  <li>LDL/HDL</li>\n</ul>",
      },
      {
        heading: "Risico's en bijwerkingen",
        body: "<p>Verwacht acne op rug en schouders, lichte vochtretentie en gestegen libido in de eerste weken.</p>\n\n<p>Wat je serieus moet monitoren via <a href=\"/risicos-en-bijwerkingen\">bloedwerk</a>:</p>\n\n<ul>\n  <li>Bloeddikte (hematocriet) boven 54 betekent bloeddonatie (verhoogd trombose-risico).</li>\n  <li>E2 boven ~45 pg/mL in combinatie met gevoelige tepels betekent <a href=\"/arimidex\">AI</a> bijsturen.</li>\n  <li>LDL kan 20-30% stijgen.</li>\n  <li>Bloeddruk vaak +5/10 mmHg.</li>\n</ul>\n\n<p>Na de kuur kan herstel 3-6 maanden duren. Bij hoge dosis/lange kuren is volledig herstel niet gegarandeerd.</p>",
      },
      {
        heading: "Onderzoek en bronnen",
        body: "<p>De klassieke Bhasin-studie liet zien dat 600 mg test enanthate per week zonder training al meer spiermassa opbouwt dan natural training (Bhasin et al., NEJM 1996).</p>\n\n<p>Voor langetermijn-cardiovasculaire data zie Basaria et al., 2010 over TRT-risico's bij oudere mannen.</p>\n\n<p>Onderdrukking van je eigen testosteron-productie en hersteltijden zijn uitgebreid beschreven in de WHO multi-center hormonal-contraception trials (Liu et al. 2003 + opvolg-studies).</p>\n\n<p><strong>Echte test van je gear:</strong></p>\n<ul>\n  <li>Stuur altijd een sample naar <a href=\"/lab\">JanoshikAnalytical</a> of Simec.cz.</li>\n  <li>Vraag elke source naar het COA per batchcode.</li>\n</ul>",
      },
      {
    ...
    sections: [
      {
        ...
        body: "<p>Nandrolon is testosteron met één koolstofatoom minder (vandaar '19-nor'). Het bindt sterk aan de androgeen-receptor, maar wordt door 5α-reductase omgezet in DHN in plaats van DHT. Daardoor is het mild voor je haarlijn en huid.</p>\n\n<p>Wat het uniek maakt:</p>\n<ul>\n  <li>Hoge collageensynthese (vandaar het 'wet joints'-gevoel).</li>\n  <li>Boost van erythropoëse.</li>\n  <li>Sterke effecten op IGF-1.</li>\n</ul>\n\n<p>De keerzijde: het bindt aan de progesteron-receptor en kan prolactine pushen. Dit kan gyno en libido-uitval triggeren.</p>\n\n<p>Daarom hoort <strong>cabergoline 0.25 mg 2x/week</strong> standaard bij elke deca-stack.</p>",
      },
      {
        heading: "Doseringen en cycle-protocol",
        body: "<p><strong>Beginnersprotocol</strong></p>\n<ul>\n  <li><a href=\"/testosteron\">Test E</a> 500 mg/wk + Deca 300 mg/wk, 14 weken.</li>\n  <li>Cabergoline 0.25 mg op maandag en donderdag vanaf week 1.</li>\n  <li><a href=\"/arimidex\">Adex</a> 0.25 mg E3D op basis van bloedwerk.</li>\n</ul>\n\n<p><strong>Intermediate</strong></p>\n<ul>\n  <li>Test 600 + Deca 500, 16 weken.</li>\n</ul>\n\n<p>NPP gebruik je als je sneller wil reageren.</p>\n<ul>\n  <li>100 mg E2D voor 10-12 weken.</li>\n  <li>Bloedspiegels reageren binnen een week.</li>\n</ul>\n\n<p><strong>Belangrijk:</strong> deca-dose &lt; test-dose, anders boem libido.</p>\n\n<p>PCT pas 3 weken na laatste Deca-prik door die lange decanoate-ester. Bij NPP wacht je 10 dagen.</p>",
      },
      {
        heading: "Risico's en bijwerkingen",
        body: "<p><strong>Prolactine stijging</strong> is het beruchtste. Controleer week 6 en houd het onder 20 ng/mL.</p>\n\n<ul>\n  <li><strong>Deca dick</strong> (libido op nul) komt door progestagene werking + te lage test-dosis.</li>\n  <li><strong>Bloeddruk</strong> stijgt door vochtretentie en verhoogde bloeddikte (hematocriet).</li>\n  <li><strong>Mentaal</strong> kun je een 'flat' gevoel krijgen — dromen worden levendig of nachtmerries.</li>\n</ul>\n\n<p>Langere kuren (&gt;16 weken) en hogere doses (&gt;600 mg) maken HPTA-herstel een hel.</p>\n\n<p>Sommige gasten zitten 6-9 maanden post-cycle in lage test, en in extreme gevallen heb je een restart-protocol nodig.</p>",
      },
      {
        heading: "Onderzoek en bronnen",
        body: "<p>Voor het klassieke profiel van nandrolon-suppressie en hersteltijden, zie Bonetti et al., 2008 over post-cycle onderdrukking van je eigen testosteron-productie en de hersteltijden bij nandrolone-decanoate.</p>\n\n<p>Voor de progestagene werking en prolactine-link: Hartgens &amp; Kuipers, Sports Med 2004 — review van bijwerkingen anabolen.</p>\n\n<p>Klinisch gebruik bij osteoporose en cachexie is onderzocht in Frisoli et al..</p>\n\n<p>Test je gear via <a href=\"/lab\">JanoshikAnalytical</a>.</p>\n\n<ul>\n  <li>Vraag bij elke source naar batchcode + COA.</li>\n  <li>Deca wordt regelmatig underdosed of vermengd met goedkopere test.</li>\n</ul>",
      },
      {
        heading: "Wanneer wel/niet kiezen",
  ...
  },
  {
    ...
    heroImage: "/img/stof/trenbolone-hero.jpg",
    heroImageAlt: "Donkere dramatische foto van een vial voor de stof-pagina trenbolone",
    resultImage: "/img/stof/trenbolone-resultaat.webp",
    ...
    sections: [
      {
        ...
        body: "<p>Trenbolone is een 19-nor verbinding, afgeleid van <a href=\"/nandrolon\">nandrolon</a>. Hij heeft een dubbele binding op de 9 en 11 positie.</p>\n\n<p>Dat maakt hem niet-aromatiseerbaar én geeft hem een androgene/anabole ratio van 500:500 vs test 100:100.</p>\n\n<ul>\n  <li>Hij bindt 3x sterker aan de androgeen-receptor dan test.</li>\n  <li>Hij blokkeert glucocorticoïden, vandaar zijn anti-katabole reputatie.</li>\n  <li>Hij pusht IGF-1 in spierweefsel.</li>\n  <li>Vetverbranding gaat omhoog via beta-adrenerge stimulatie.</li>\n</ul>\n\n<p>Maar:</p>\n\n<ul>\n  <li>Hij bindt aan progesteron-receptor: gyno-risico via die route, niet via omzetting in oestrogeen.</li>\n  <li>Hij pusht prolactine.</li>\n  <li>Hij stresst nieren/cardiovasculair flink.</li>\n</ul>\n\n<p><strong>Geen tren zonder <a href=\"/testosteron\">test</a>-basis</strong> — pure tren only is een snelle weg naar mentale ellende.</p>",
      },
      {
        heading: "Doseringen en cycle-protocol",
        body: "<p><strong>Eerste tren-kuur (na minstens 3 test-only kuren):</strong></p>\n\n<ul>\n  <li><a href=\"/testosteron\">Test E</a> 300-400 mg/wk + Tren A 50 mg E2D (175 mg/wk), 8-10 weken.</li>\n  <li>Caber 0.25 mg 2x/wk vanaf week 1.</li>\n</ul>\n\n<p>Houd test-dosis lager dan tren-dosis voor maximaal droog effect, of gelijk voor meer comfort.</p>\n\n<p><strong>Intermediate:</strong></p>\n\n<ul>\n  <li>Test 300 + Tren E 300-400 mg/wk, 12 weken.</li>\n</ul>\n\n<p><strong>Geavanceerd:</strong></p>\n\n<ul>\n  <li>Test 200 + Tren 500 + <a href=\"/masteron\">Mast</a> 400 (klassieke recomp).</li>\n</ul>\n\n<p>PCT pas 10 dagen na laatste Tren A-prik, 21 dagen na Tren E.</p>\n\n<p>Nachtkussen wegleggen want je gaat zweten.</p>",
      },
      {
        heading: "Risico's en bijwerkingen",
        body: "<p>Wat je gaat voelen:</p>\n<ul>\n  <li>Nachtelijk zweten (klamzweet, lakens verschonen).</li>\n  <li>Slapeloosheid (val moeilijk in, kort REM).</li>\n  <li>Cardio gaat door het dak (5 min op de loopband voelt als 20).</li>\n  <li>Bloeddruk +15/10.</li>\n  <li>Donkere urine (metaboliet-kleur, normaal maar check nierfunctie).</li>\n  <li>'Tren rage' (kortere lont — wees alert op je gedrag).</li>\n  <li>Depressie/somberheid bij gevoelige gasten.</li>\n</ul>\n<p><strong>Cardiovasculair:</strong></p>\n<ul>\n  <li>LDL kan verdubbelen.</li>\n  <li>HDL kan halveren.</li>\n</ul>\n<p>Gyno via progesteron — caber niet skippen.</p>\n<p>Coughs vlak na injectie (tren cough) komen voor: 30-90 seconden brandend hoesten, normaal als je niet aspireert.</p>",
      },
      {
        heading: "Onderzoek en bronnen",
        body: "<p>Trenbolone is paradoxaal weinig onderzocht in mensen (veterinair veel: Heitzman, 1976).</p>\n\n<p>Voor cardiovasculair risico in androgeen-gebruikers in het algemeen zie Baggish et al., Circulation 2017 over langetermijn-cardiotoxiciteit bij AAS-gebruikers.</p>\n\n<p>Voor mentale bijwerkingen: Pope et al., 2000 over stemmings- en agressie-veranderingen.</p>\n\n<p>Voor renale stress en tren: case reports zoals Almukhtar et al., 2015.</p>\n\n<p><strong><a href=\"/lab\">Lab-testen</a> verplicht</strong> — tren wordt vaak underdosed of geleverd als test-suspension met tren-kleurtje.</p>\n\n<p>JanoshikAnalytical voor HPLC.</p>",
      },
      {
        heading: "Wanneer wel/niet kiezen",
  ...
  },
  {
    ...
    heroImage: "/img/stof/boldenone-hero.jpg",
    heroImageAlt: "Donkere moody foto van vials voor de stof-pagina boldenone (equipoise)",
    resultImage: "/img/stof/boldenone-resultaat.webp",
    ...
    sections: [
      {
        ...
        body: "<p>Boldenone is <a href=\"/testosteron\">testosteron</a> met een extra dubbele binding op carbon 1. Chemisch is het bijna identiek aan <a href=\"/dianabol\">dianabol</a> minus de c17-methylatie, vandaar injectable in plaats van oral.</p>\n\n<p>Het bindt redelijk aan de androgeen-receptor, maar het echte unieke effect zit in extreme erytropoëse.</p>\n\n<ul>\n  <li>Rode bloedcellen schieten omhoog.</li>\n  <li>Bloeddikte (hematocriet) stijgt snel.</li>\n  <li>Je cardio-output wordt absurd.</li>\n</ul>\n\n<p>Pumps tijdens training kunnen pijnlijk zijn. Denk aan rugpump tijdens deadlifts waardoor je moet stoppen.</p>\n\n<p>Het aromatiseert mild, ongeveer de helft van test.</p>\n\n<p>Het verhoogt eetlust significant via ghrelin-modulatie.</p>\n\n<ul>\n  <li>Handig voor bulk.</li>\n  <li>Lastig als je een cut probeert.</li>\n</ul>",
      },
      {
        heading: "Doseringen en cycle-protocol",
        body: "<p><strong>Beginner EQ-cycle</strong> (na ten minste 2 test-only kuren):</p>\n\n<ul>\n  <li><a href=\"/testosteron\">Test E</a> 400 mg/wk + EQ 500 mg/wk</li>\n  <li>16 weken minimum, want EQ kickt traag in.</li>\n</ul>\n\n<p>Sommigen voegen <a href=\"/dianabol\">Dbol</a> 30 mg/dag toe voor weken 1-4 als kickstart. Dan zit je niet zes weken op je gevoel te wachten.</p>\n\n<p><strong>Intermediate:</strong></p>\n\n<ul>\n  <li>Test 500 + EQ 600-700 mg/wk</li>\n  <li>18-20 weken</li>\n</ul>\n\n<p><a href=\"/arimidex\">Adex</a> op basis van bloedwerk (lage omzetting in oestrogeen maar dosering is hoog).</p>\n\n<ul>\n  <li>Hematocriet vóór de kuur meten — boven 50 al, dan plan een donatie in voor week 8.</li>\n  <li>Voor 18-weekse kuren is bloedwerk op weken 6, 12 en 18 het minimum.</li>\n</ul>",
      },
      {
        heading: "Risico's en bijwerkingen",
        body: "<p><strong>Hematocriet</strong> — dit is de big one. EQ kan binnen 10 weken je bloeddikte (hematocriet) 5-8 punten omhoog tikken.</p>\n\n<p>Boven 54 ben je in trombose-risico territorium en moet je bloed doneren of dosis halveren.</p>\n\n<p>Klachten van hoge bloeddikte (hematocriet):</p>\n<ul>\n  <li>hoofdpijn</li>\n  <li>duizeligheid bij staan</li>\n  <li>rode/paarse gelaatskleur</li>\n  <li>hoge bloeddruk</li>\n</ul>\n\n<p>Andere bijwerkingen:</p>\n<ul>\n  <li>extreem verhoogde eetlust (kan handig zijn, kan saboteren)</li>\n  <li>milde acne</li>\n  <li>langzame angst-stijging bij sommige gevoelige gasten ('EQ-angst', deels door bloeddikte (hematocriet)-druk)</li>\n</ul>\n\n<p><strong>PCT-timing:</strong> 21 dagen na laatste prik door die lange undecylenate-ester.</p>",
      },
      {
        heading: "Onderzoek en bronnen",
  ...
  },
  {
    ...
    heroImage: "/img/stof/masteron-hero.jpg",
    heroImageAlt: "Macro close-up foto van een vial voor de stof-pagina masteron",
    resultImage: "/img/stof/masteron-resultaat.webp",
    ...
    sections: [
      {
        ...
        body: "<p>Masteron (drostanolone) is een afgeleide van DHT. Toegevoegd is een 2-methyl-groep die het beschermt tegen 3-alpha-HSD-afbraak in spierweefsel.</p>\n\n<p>Het bindt aan SHBG, waardoor minder van je test gebonden wordt en meer vrij <a href=\"/testosteron\">testosteron</a> circuleert. Daarnaast werkt het als zwakke aromatase-binder zonder receptor-activatie — vandaar mild anti-oestrogeen effect.</p>\n\n<ul>\n  <li>Geen omzetting in oestrogeen betekent geen vochtretentie.</li>\n  <li>Geen omzetting in oestrogeen betekent geen E2-bloat.</li>\n</ul>\n\n<p>Het geeft een 'gripperig' droog gevoel in spieren en visuele hardheid die op foto's pops.</p>\n\n<p><strong>Geen massa-builder</strong> — een esthetische polish-stof.</p>",
      },
      {
        heading: "Doseringen en cycle-protocol",
        body: "<p><strong>Klassiek cut-stack:</strong></p>\n<ul>\n  <li><a href=\"/testosteron\">Test E</a> 300 mg + Mast E 400-500 mg, 12 weken.</li>\n</ul>\n\n<p><strong>Voor recomp:</strong></p>\n<ul>\n  <li>Test 300 + <a href=\"/trenbolone\">Tren E</a> 200 + Mast E 400, 10-12 weken (de zogenaamde 'TRT-Tren-Mast').</li>\n</ul>\n\n<p>Pre-contest gasten gaan tot 600-800 mg Mast E in de laatste 6 weken.</p>\n\n<p>Mast P (propionate) wordt vaak in de laatste 4 weken vóór een show toegevoegd voor extra polish, 100 mg E2D — sneller in/uit.</p>\n\n<p><strong>Beginnerstip:</strong> voor je eerste cut probeer Test + Mast eerst voordat je Tren toevoegt.</p>\n\n<p>Veel gasten ontdekken dat Mast alleen al voor flink wat hardness zorgt zonder de tren-bijwerkingen.</p>",
      },
      {
        heading: "Risico's en bijwerkingen",
        body: "<p>Mild profiel maar wel echt androgeen. Bij genetische gevoeligheid kan het haaruitval versnellen, zichtbaar binnen 6-8 weken bij wie aanleg heeft.</p>\n\n<ul>\n  <li>Acne kan ook opspelen, vooral op rug en schouders.</li>\n  <li>Cardiovasculair: LDL stijgt 15-25%, HDL daalt 30-40% bij hogere doses — vergelijkbaar met andere DHT-derivaten.</li>\n  <li>Prostaat-volume kan licht stijgen. PSA-check als je 40+ bent.</li>\n  <li>Stemming meestal stabiel, libido vaak verhoogd door hormoon-binding.</li>\n</ul>\n\n<p>Geen lever-issues (injectable), geen oestrogene rommel.</p>\n\n<ul>\n  <li><strong>PCT-timing:</strong> 3 weken na Mast E.</li>\n  <li><strong>PCT-timing:</strong> 10 dagen na Mast P.</li>\n</ul>",
      },
      {
        heading: "Onderzoek en bronnen",
        body: "<p>Drostanolone werd oorspronkelijk onderzocht als adjuvante behandeling bij gemetastaseerd borstcarcinoom (DeRivas, 1972) — vandaar de anti-oestrogene reputatie.</p>\n\n<p>Voor hormoon-binding en vrij testosteron-effect, zie Saartok et al., 1984 over receptor-binding profielen van DHT-derivaten.</p>\n\n<p>Voor cardiovasculair profiel van DHT-derivaten in het algemeen: Hartgens et al., 2004 (lipiden-impact).</p>\n\n<p>Masteron is een stof die regelmatig wordt vervalst — meestal als simpel test prop in dezelfde kleur olie.</p>\n\n<p>HPLC-test via JanoshikAnalytical of Simec.</p>",
      },
      {
        heading: "Wanneer wel/niet kiezen",
  ...
  },
  {
    ...
    heroImage: "/img/stof/anavar-hero.jpg",
    heroImageAlt: "Donkere productfoto van een blister voor de stof-pagina anavar",
    resultImage: "/img/stof/anavar-resultaat.webp",
    ...
    sections: [
      {
        ...
        body: "<p>Anavar (oxandrolone) is een c17-alpha gealkyleerd DHT-derivaat. Alpha-methylatie maakt het oraal biobeschikbaar zonder eerste-pass lever-afbraak.</p>\n\n<p>Het bindt aan de androgeen-receptor met matige affiniteit, maar drijft eiwitsynthese en stikstofretentie sterk op zonder vochtretentie. Lipolyse (vetverbranding) wordt licht geboost via verhoogde T3-uptake in vet- en spierweefsel.</p>\n\n<p>Klinisch onderzocht bij brandwondenpatiënten, waar het bewezen spier-rebehoud gaf bij <strong>80 mg/dag</strong>.</p>\n\n<p>Het is een van de weinige anabolen veilig genoeg om vrouwen op te zetten (lage virilisatie-risico) in microdoses:</p>\n\n<ul>\n  <li><strong>5-10 mg/dag</strong></li>\n</ul>",
      },
      {
        heading: "Doseringen en cycle-protocol",
        body: "<p><strong>Beginner:</strong> 40-50 mg/dag, 6-8 weken, gesplitst in 2 giften (ochtend + avond want halfwaardetijd is 8 uur).</p>\n\n<p>Altijd op test-basis — 300-400 mg <a href=\"/testosteron\">Test E</a> erbij is standaard.</p>\n\n<ul>\n  <li><strong>Intermediate:</strong> 60-80 mg/dag, 8 weken max.</li>\n  <li><strong>Pre-contest gasten:</strong> 80-100 mg in de laatste 4-6 weken.</li>\n  <li><strong>Vrouwen:</strong> 5-10 mg/dag, 4-6 weken — bij hogere doses begint virilisatie (stem, libido, clit).</li>\n</ul>\n\n<p>Lever-supps niet skippen:</p>\n\n<ul>\n  <li>TUDCA 500 mg/dag</li>\n  <li>NAC 1200 mg/dag</li>\n  <li>Idealiter geen alcohol tijdens de cycle</li>\n</ul>\n\n<ul>\n  <li><strong>Week 4:</strong> bloedwerk voor lever-enzymen.</li>\n  <li><strong>Week 8:</strong> bloedwerk voor lever-enzymen.</li>\n</ul>",
      },
      {
        heading: "Risico's en bijwerkingen",
        body: "<p><strong>Hepatotoxiciteit:</strong> mild in vergelijking met <a href=\"/dianabol\">dbol</a> of <a href=\"/winstrol\">winstrol</a>, maar nog steeds aanwezig. ALAT/ASAT stijgt licht, vaak 1.5-2x bovengrens.</p>\n\n<ul>\n  <li>HDL-cholesterol is de hardste hit — kan met 30-50% dalen, soms onder 20 mg/dL bij hogere doses.</li>\n  <li>LDL stijgt 15-25%.</li>\n  <li>Bloeddruk meestal stabiel.</li>\n  <li>Acne mild, haaruitval mild (let op bij aanleg).</li>\n</ul>\n\n<p><strong>Suppressie van eigen test:</strong> minder dramatisch dan andere stoffen maar wel echt — 4 weken anavar onderdrukt LH/FSH significant. PCT verplicht na elke cycle.</p>\n\n<p>Een minder bekend effect: spierkrampen, vooral kuiten en lower back.</p>\n\n<ul>\n  <li>Verhoog dan magnesium 400 mg + zout intake.</li>\n</ul>",
      },
      {
        heading: "Onderzoek en bronnen",
        body: "<p>Een van de best gedocumenteerde anabolen in klinische context.</p>\n\n<ul>\n  <li>Voor brandwondenherstel-onderzoek met 80 mg/dag: Demling, 2005 over oxandrolone in catabolic conditions.</li>\n  <li>Voor het iconische 1995 onderzoek over oxandrolone en weight regain bij HIV-patiënten: Berger et al., 1996.</li>\n  <li>Voor lever-effecten in detail: Petrovic et al., 2010.</li>\n</ul>\n\n<p>Anavar wordt extreem vaak vervalst.</p>\n\n<ul>\n  <li>Ruwe oxandrolone-poeder kost ~$30/gram.</li>\n  <li>Dianabol kost ~$0.50/gram.</li>\n</ul>\n\n<p>Vraag altijd <a href=\"/lab\">HPLC-test</a> van de batch (JanoshikAnalytical, Simec).</p>\n\n<p><strong>Echte var:</strong> subtiele krachttoename, geen extreme bloat.</p>\n\n<p>Krijg je in week 1 al 4 kg + bloat? Het is geen var.</p>",
      },
      {
        heading: "Wanneer wel/niet kiezen",
  ...
  },
  {
    ...
    heroImage: "/img/stof/dianabol-hero.jpg",
    heroImageAlt: "Donkere editorial foto van tabletten voor de stof-pagina dianabol",
    resultImage: "/img/stof/dianabol-resultaat.webp",
    ...
    sections: [
      {
        ...
        body: "<p>Dianabol is <a href=\"/testosteron\">testosteron</a> met een extra 1-2 dubbele binding en een 17-alpha methyl-groep.</p>\n\n<p>Dat laatste maakt het oraal opneembaar, maar belast wel je lever. Het bindt sterk aan de androgeen-receptor, pusht eiwitsynthese en geeft enorme glycogeenopslag in spier.</p>\n\n<p>Vandaar de pump en het volle uiterlijk. Het aromatiseert agressief naar oestradiol.</p>\n\n<ul>\n  <li>Vochtretentie</li>\n  <li>Libido</li>\n  <li>De typische 'dbol bloat'</li>\n</ul>\n\n<p>De werkingsduur is kort (5 uur), dus splitsen over 2-3 giften per dag voor stabiele plasmaspiegel.</p>\n\n<p><strong>Effect in week 1:</strong></p>\n\n<ul>\n  <li>Gewicht +2-3 kg (vooral water/glycogeen)</li>\n  <li>Kracht serieus omhoog</li>\n  <li>Pumps die ridicuul worden</li>\n</ul>",
      },
      {
        heading: "Doseringen en cycle-protocol",
        body: "<p><strong>Klassieke kickstart:</strong> <a href=\"/testosteron\">Test E</a> 500 mg/wk x 14 weken + Dbol 30 mg/dag in weken 1-4.</p>\n\n<p>Beginner kickstart-dose 20-25 mg/dag, intermediate 30-40 mg, geavanceerd tot 50 mg.</p>\n\n<p>Cycle-duur Dbol max 6 weken vanwege lever — daarna stoppen, injectable doorlopen.</p>\n\n<p>Verdeel over 3 giften:</p>\n<ul>\n  <li>'t ochtends</li>\n  <li>lunch</li>\n  <li>vroege avond</li>\n</ul>\n\n<p>Of neem preworkout (1 hour vóór training) als single dose voor pump-focus.</p>\n\n<p><a href=\"/arimidex\">Adex</a> 0.25 mg E3D vanaf week 1 vrijwel altijd nodig (Dbol + Test = veel E2).</p>\n\n<p><strong>Lever-supps:</strong></p>\n<ul>\n  <li>TUDCA 500-1000 mg/dag</li>\n  <li>NAC 1200 mg</li>\n  <li>geen alcohol</li>\n</ul>",
      },
      {
        heading: "Risico's en bijwerkingen",
        body: "<p>Lever-enzymen stijgen 2-4x bovengrens — normaal op dbol, herstelt 4-6 weken na stop.</p>\n\n<p>Bloeddruk gaat hard omhoog door vochtretentie en E2-spike — verwacht +10-20 systolisch. Hoofdpijn vooral in week 1-2 (E2-piek).</p>\n\n<ul>\n  <li>HDL crasht 30-50%.</li>\n  <li>Gyno-risico hoog door agressieve omzetting in oestrogeen — adex erbij is geen optioneel ding, het is verplicht.</li>\n  <li>Acne, vooral op rug.</li>\n  <li>Lethargie/sufheid kan voorkomen door methyl-groep belasting.</li>\n</ul>\n\n<p>Suppressie van eigen test compleet binnen 7-10 dagen.</p>\n\n<p>Pure Dbol-only cycles (geen test) zijn een drama — libido op nul tegen week 3.</p>",
      },
      {
        heading: "Onderzoek en bronnen",
    ...
    sections: [
      {
        ...
        body: "<p>Stanozolol is een DHT-derivaat met een pyrazol-ring gekoppeld aan het A-ring. Dat maakt het oraal opneembaar én geeft de unieke 'droge' werking.</p>\n\n<ul>\n  <li>Het bindt aan de androgeen-receptor.</li>\n  <li>Het pusht eiwitsynthese.</li>\n  <li>Het bindt agressief aan SHBG (Sex Hormone Binding Globulin), waardoor minder van je test gebonden wordt en meer vrij circulerend testosteron beschikbaar komt.</li>\n</ul>\n\n<p>Dit verklaart waarom Winstrol-stacks vaak supercharged voelen — je test-cycle krijgt een free-test boost.</p>\n\n<p>Geen omzetting in oestrogeen, geen vochtretentie — vandaar het strakke 'sliced' uiterlijk.</p>\n\n<p>Injectable winny is een microcrystalline suspension in water. Die kristallen geven extra pip (post-injection pain), maar dezelfde stanozolol-molecuul als de tabletten.</p>",
      },
      {
        heading: "Doseringen en cycle-protocol",
        body: "<p><strong>Klassiek pre-contest:</strong> <a href=\"/testosteron\">Test</a> 300 + <a href=\"/masteron\">Mast E</a> 400 + Winstrol 50 mg/dag in laatste 6 weken.</p>\n\n<ul>\n  <li><strong>Beginner-dose:</strong> 25-30 mg/dag oraal.</li>\n  <li><strong>Intermediate:</strong> 50 mg.</li>\n  <li><strong>Geavanceerd:</strong> 75 mg max.</li>\n  <li><strong>Injectable:</strong> 50 mg E2D of dagelijks.</li>\n</ul>\n\n<p>Cycles 6-8 weken vanwege lever. Splits oraal in 2 giften: ochtend + 8-10 uur later.</p>\n\n<p><strong>Stack regel:</strong> niet met andere c17-α orals (<a href=\"/dianabol\">dbol</a>, anadrol, anavar dubbel-stack = leverdood).</p>\n\n<ul>\n  <li>Mast + Winstrol + Test is de gouden cut-stack.</li>\n  <li>Voor recomp: Test + Tren + Mast + Winstrol als finisher (laatste 4 wkn).</li>\n</ul>\n\n<ul>\n  <li><strong>Lever-supps:</strong> TUDCA 1000 mg/dag.</li>\n  <li>NAC 1200 mg.</li>\n  <li>Omega-3 4 g voor lipiden.</li>\n</ul>\n\n<p>Bloedwerk week 3 en 6.</p>",
      },
      {
        heading: "Risico's en bijwerkingen",
        body: "<p>Lipiden zijn de big one — Winstrol is de allerergste anabolic qua HDL-impact.</p>\n\n<ul>\n  <li>HDL kan met 50-70% dalen, soms onder 15 mg/dL.</li>\n  <li>LDL stijgt 30-50%.</li>\n</ul>\n\n<p><a href=\"/risicos-en-bijwerkingen\">Cardiovasculair risico</a> schiet omhoog, vooral als je al een familiegeschiedenis hebt.</p>\n\n<p>Gewrichten: droogheid in synoviaal vocht maakt squat, deadlift, bench oncomfortabel. Sommige gasten draaien daarom een lage <a href=\"/nandrolon\">deca</a>-dose (200 mg) als 'joint cushion' tijdens een winny-cycle.</p>\n\n<ul>\n  <li>Lever-enzymen 2-4x bovengrens.</li>\n  <li>Acne kan opspelen.</li>\n  <li>Suppressie compleet.</li>\n  <li>Pees-blessures: meldingen van ruptures op winny zijn niet zeldzaam — verminder de last bij zware sets, vooral cold.</li>\n  <li>Bloeddruk omhoog.</li>\n  <li>PIP bij injectable is berucht (vandaar dat veel gasten oral kiezen).</li>\n</ul>",
      },
      {
        heading: "Onderzoek en bronnen",
        body: "<p>Stanozolol is uitgebreid onderzocht in klinische context voor hereditair angio-oedeem en aplastische anemie.</p>\n\n<ul>\n  <li>Voor lipiden-impact specifiek bij Winstrol: Thompson et al., 1989 over HDL-crash bij stanozolol 6 mg/dag (zelfs TRT-dose verlaagt HDL met 33%).</li>\n  <li>Voor lever-effecten en hepatotoxiciteit van c17-α anabolen: Kafrouni et al., 2007.</li>\n  <li>Voor de hormoon-binding studie: Pugeat et al., 1981.</li>\n</ul>\n\n<p>Vervalsing: winstrol-tabs worden soms vervalst met dbol of dianabol/stanozolol-mix.</p>\n\n<p>Echte winny voelt droog, dbol vochtig — dat is een eerste sanity-check, maar HPLC blijft de enige zekerheid.</p>",
      },
      {
        heading: "Wanneer wel/niet kiezen",
    ...
    sections: [
      {
        ...
        body: "<p>Methenolone is een DHT-derivaat met een 1-methyl-groep — beschermd tegen 3α-HSD-afbraak in spierweefsel.</p>\n\n<ul>\n  <li>Bindt matig aan de androgeen-receptor met lage androgene/hoge anabole ratio (88/44 vs test 100/100).</li>\n  <li>Aromatiseert niet, geen oestrogene effecten, geen vochtretentie.</li>\n</ul>\n\n<p>Het effect is subtiel maar kwalitatief:</p>\n\n<ul>\n  <li>lean mass;</li>\n  <li>behoud van spier in caloriedeficit;</li>\n  <li>lichte recomp.</li>\n</ul>\n\n<p>Tegen lipolyse heeft het ook bescheiden effect.</p>\n\n<p>Het is de stof die je kiest als je 'natural plus' wil zien, zonder de zichtbare bloat van <a href=\"/testosteron\">Test</a> of de droge hardness van <a href=\"/masteron\">Mast</a>.</p>\n\n<p>In cutfase indrukwekkend voor spierbehoud bij caloriedeficit.</p>",
      },
      {
        heading: "Doseringen en cycle-protocol",
        body: "<p><strong>Beginner met primo</strong> (na minimaal 2 test-only kuren):</p>\n<ul>\n  <li><a href=\"/testosteron\">Test E</a> 250-300 + Primo E 500-600 mg/wk</li>\n  <li>14-16 weken</li>\n</ul>\n\n<p><strong>Intermediate:</strong></p>\n<ul>\n  <li>Test 300 + Primo 700-800 mg/wk</li>\n</ul>\n\n<p><strong>Geavanceerd:</strong></p>\n<ul>\n  <li>Primo tot 1000 mg/wk in extended protocols</li>\n  <li>Maar de prijs wordt absurd.</li>\n</ul>\n\n<p>Onder 400 mg/wk voel je amper iets. Primo werkt traag: de eerste duidelijke effecten komen in week 4-6.</p>\n\n<p>Primo Acetate (oral) wordt soms gebruikt:</p>\n<ul>\n  <li>75-100 mg/dag, verdeeld over 3 giften</li>\n  <li>Kortere halfwaardetijd betekent 4-5x daags doseren voor optimaal effect.</li>\n</ul>\n\n<p><a href=\"/arimidex\">Adex</a> is niet of nauwelijks nodig. De test-basis aromatiseert wel, dus check E2.</p>\n\n<p>PCT 21 dagen na laatste Primo E-shot.</p>",
      },
      {
        heading: "Risico's en bijwerkingen",
        body: "<p>Het mildste profiel van alle injectables — vandaar de populariteit bij voorzichtige gebruikers.</p>\n\n<ul>\n  <li>Geen omzetting in oestrogeen = geen E2-issues.</li>\n  <li>Lage androgene activiteit = weinig acne, weinig haaruitval impact.</li>\n  <li>Bij genetische aanleg is haaruitval nog steeds mogelijk.</li>\n  <li>Lipiden-impact mild vergeleken met andere DHT's, HDL daalt 15-25%.</li>\n  <li>Lever-enzymen blijven stabiel bij Primo E (injectable).</li>\n</ul>\n\n<p>Suppressie is reëel, maar herstel meestal vlotter dan op bv <a href=\"/trenbolone\">tren</a> of <a href=\"/nandrolon\">deca</a>.</p>\n\n<p><strong>Belangrijkste risico:</strong> dat je geen echt primo hebt.</p>\n\n<p>Verkeerde stof in plaats van methenolone (vaak test) geeft je een ander bijwerkingsprofiel dan verwacht. Denk je dat je geen E2-management nodig hebt, dan groei je gyno omdat de ampul gewoon Test E was.</p>",
      },
      {
        heading: "Onderzoek en bronnen",
        body: "<p>Methenolone werd oorspronkelijk in oncologie gebruikt voor borstkanker en cachexie.</p>\n\n<p>Voor klassieke methenolone-pharmacokinetiek en bindings-profiel: Saartok et al., 1984 (vergelijking DHT-derivaten). Voor toepassing bij aplastische anemie: Allen et al., 1968.</p>\n\n<p>Voor lipiden-impact in androgeen-gebruikers algemeen: Hartgens et al., 2004.</p>\n\n<p>Vervalsing: Coopman &amp; Cordonnier, 2012 over kwaliteits-issues van underground anabolen — primo is een case study.</p>\n\n<p>Test je product via <a href=\"/lab\">JanoshikAnalytical</a> of Simec.cz — laat ampul HPLC-tested zijn vóór gebruik, niet erna.</p>",
      },
      {
        heading: "Wanneer wel/niet kiezen",
  ...
  // ---------- PCT ----------
  {
    ...
    heroImage: "/img/stof/nolvadex-hero.jpg",
    heroImageAlt: "Editorial foto van een amber bottle voor de stof-pagina nolvadex",
    resultImage: "/img/stof/nolvadex-resultaat.webp",
    ...
    sections: [
      {
        ...
        body: "<p>Tamoxifen bindt aan oestrogeen-receptoren maar werkt weefsel-selectief:</p>\n\n<ul>\n  <li>In borstweefsel als antagonist: het blokkeert oestrogeen — vandaar anti-gyno.</li>\n  <li>In lever en bot als agonist: vandaar een mild positief effect op lipiden en botdichtheid.</li>\n</ul>\n\n<p><strong>Belangrijk voor PCT:</strong> in de hypothalamus en hypofyse blokkeert het oestrogeen-negatieve feedback, waardoor je LH en FSH-productie weer aanslaat.</p>\n\n<p>LH stimuleert dan Leydig-cellen in de testes om testosteron te maken. Het effect bouwt op binnen 7-10 dagen.</p>\n\n<p>Het werkt niet via oestrogeen-verlaging, zoals AI's, maar via receptor-blokkade. Vandaar dat het tijdens PCT ideaal is: oestrogeen heb je nodig voor LH-feedback, alleen niet op gevoelige weefsels.</p>",
      },
      {
        heading: "Doseringen en cycle-protocol",
        body: "<p><strong>Klassieke PCT</strong></p>\n<ul>\n  <li><strong>Week 1-2:</strong> 40 mg/dag</li>\n  <li><strong>Week 3-4:</strong> 20 mg/dag</li>\n</ul>\n\n<p>Vaak gecombineerd met <a href=\"/clomid\">Clomid</a> (50/50/25/25) voor sterkere HPTA-stimulatie.</p>\n\n<p><strong>Start PCT-timing</strong> hangt af van je laatste ester:</p>\n<ul>\n  <li>Test Prop = 3-5 dagen</li>\n  <li>Test E/C = 14 dagen</li>\n  <li>Sustanon = 21 dagen</li>\n  <li>Deca/EQ = 21-28 dagen</li>\n</ul>\n\n<p><strong>Tijdens cycle voor gyno:</strong> bij eerste tepel-gevoeligheid of knobbeltje start 10-20 mg/dag voor 2-4 weken.</p>\n\n<p>Veel sneller effectief bij borst-symptomen dan een <a href=\"/arimidex\">AI</a>.</p>\n\n<p><strong>Voor ernstige gyno (zichtbare knobbel):</strong> 20-40 mg/dag 4-6 weken kan het terugdraaien — maar als het 6+ maanden oud is, helpt alleen chirurgie.</p>",
      },
      {
        heading: "Risico's en bijwerkingen",
        body: "<p>Mild profiel, maar niet zonder risico's.</p>\n\n<ul>\n  <li>Visuele veranderingen mogelijk, maar zeldzamer dan Clomid: flikkering en lichtgevoeligheid.</li>\n  <li>Stemmingsdips komen voor — sommige gasten worden op tamox down of lusteloos.</li>\n  <li>Verminderd libido in de eerste 1-2 weken: je lichaam moet opstarten.</li>\n</ul>\n\n<p>Mild positief effect op cholesterol: HDL stijgt licht en LDL daalt. Geen reden om bezorgd te zijn.</p>\n\n<p>Trombose-risico is verhoogd in klinische oncologie-doses van 20 mg/dag jarenlang, maar bij PCT-doses van 4 weken klinisch verwaarloosbaar.</p>\n\n<p>Lever-enzymen blijven meestal stabiel.</p>\n\n<p><strong>Belangrijke note:</strong> tamox blokkeert oestrogeen-positieve effecten in de IGF-1-cascade. Sommigen ervaren daardoor een dip in 'pump' en gain-behoud in de PCT-weken.</p>",
      },
      {
        heading: "Onderzoek en bronnen",
        body: "<p>Tamoxifen is een van de meest onderzochte medicijnen wereldwijd.</p>\n\n<ul>\n  <li>Voor de klassieke PCT-mechanisme studie: Coviello et al., 2005 over tamoxifen-effect op LH en testosteron-recovery na androgeen-suppressie.</li>\n  <li>Voor gyno-behandeling is tamoxifen in meerdere randomized trials vergeleken met AI (anti-oestrogeen middel)s bij idiopathische gynaecomastie — review-data wijst tamoxifen aan als first-line behandeling.</li>\n  <li>Voor lever- en cardiovasculaire veiligheid bij langere therapie: Fisher et al., 1998.</li>\n</ul>\n\n<p>Tamoxifen is een echt geregistreerd geneesmiddel — verkrijgbaar als Nolvadex (brand) of generic tamoxifen.</p>\n\n<p>Pharma-grade is gemakkelijk te krijgen via researchchem-sources, kwaliteit-issues zijn minder dan bij UGL anabolen.</p>",
      },
      {
        heading: "Wanneer wel/niet kiezen",
    ...
    sections: [
      {
        ...
        body: "<p>Clomifene citrate is een mengsel van twee isomeren:</p>\n\n<ul>\n  <li>zuclomifeen (oestrogene werking, langer in lichaam)</li>\n  <li>enclomifeen (anti-oestrogene werking, korter)</li>\n</ul>\n\n<p>Het bindt aan oestrogeen-receptoren in de hypothalamus en blokkeert daar de negatieve feedback van oestrogeen op GnRH-productie.</p>\n\n<p>Resultaat: GnRH gaat omhoog, hypofyse pompt LH en FSH uit, en de Leydig-cellen in je testes worden gestimuleerd om testosteron te produceren.</p>\n\n<p>Effect op LH-spike is meetbaar binnen 3-5 dagen.</p>\n\n<p>Sterker dan Nolva qua pure LH-stimulatie, maar de zuclomifeen-isomeer blijft weken in je systeem rondhangen en is verantwoordelijk voor veel van de mentale ellende.</p>\n\n<p>Enclomifeen-only (Androxal) bestaat als alternatief — zonder de stemmingsproblemen — maar is veel duurder en moeilijker te krijgen.</p>",
      },
      {
        heading: "Doseringen en cycle-protocol",
        body: "<p><strong>Klassiek Clomid PCT:</strong></p>\n<ul>\n  <li><strong>Week 1-2:</strong> 50 mg/dag</li>\n  <li><strong>Week 3-4:</strong> 25 mg/dag</li>\n</ul>\n\n<p>Vrijwel altijd gecombineerd met <a href=\"/nolvadex\">Nolvadex</a> (40/40/20/20).</p>\n\n<p>Voor zwaardere cycles (16+ weken, hoge doses, stacks met <a href=\"/trenbolone\">tren</a>/<a href=\"/nandrolon\">deca</a>):</p>\n<ul>\n  <li><strong>Dag 1:</strong> front-load met 100 mg</li>\n  <li><strong>Week 1-2:</strong> 50 mg/dag</li>\n</ul>\n\n<p>Start-timing zelfde als Nolva — hangt van ester af:</p>\n<ul>\n  <li>Test E: 14 dgn na laatste prik</li>\n  <li>deca: 21-28 dgn</li>\n  <li>etc</li>\n</ul>\n\n<p>Sommige gasten gebruiken Clomid solo voor extra LH-push:</p>\n<ul>\n  <li>50/50/25/25</li>\n  <li>100/50/50/25</li>\n</ul>\n\n<p>Werkt, maar bijwerkingen vermenigvuldigen.</p>\n\n<p>Voor lichte cycles (kortere oral-only cycles van 6 wkn) is 25 mg/dag voor 3 weken vaak voldoende.</p>",
      },
      {
        heading: "Risico's en bijwerkingen",
        body: "<p><strong>De big one: visuele veranderingen.</strong> Flikkering, glow-haloen rond lichten, lichtgevoeligheid, soms wazig zien. Bij meeste mensen mild en omkeerbaar — bij sommigen blijvend (zeldzaam).</p>\n\n<p>Bij visuele klachten: stop en switch naar puur Nolva.</p>\n\n<p>Stemmingsdips zijn berucht — laag energie, mentale mist, kort lontje, soms depressieve gevoelens. Vandaar dat veel gasten zeggen 'Clomid voelt erger dan de cycle zelf'.</p>\n\n<ul>\n  <li>Libido-dip in eerste 1-2 weken (lichaam moet opstarten).</li>\n  <li>Migraine kan voorkomen.</li>\n</ul>\n\n<p>Cardiovasculair: mild positief op lipiden (HDL stijgt). Trombose-risico in oncologie-doses, bij PCT-doses verwaarloosbaar.</p>\n\n<ul>\n  <li>Hoofdpijn, opvliegers en misselijkheid bij hogere doses.</li>\n</ul>",
      },
      {
        heading: "Onderzoek en bronnen",
        body: "<p>Clomifene citrate is al sinds 1967 in klinisch gebruik.</p>\n\n<p>Voor het gebruik bij hypogonadisme en HPTA-restart: Katz et al., 2012 over clomifene-citrate effect op testosteron en LH bij hypogonadale mannen.</p>\n\n<p>Voor PCT specifiek: Tsourdi et al., 2009 over SERM-protocollen voor androgeen-deficient mannen.</p>\n\n<p>Voor visuele bijwerkingen en oogheelkundige effecten: Purvin, 1995.</p>\n\n<p>Voor enclomifeen-only alternatief: Wiehle et al., 2014.</p>\n\n<p>Clomid is een pharma-grade geregistreerd geneesmiddel, kwaliteit-issues bij researchchem-sources beperkt.</p>",
      },
      {
        heading: "Wanneer wel/niet kiezen",
        body: "<p><strong>Wel kiezen voor:</strong></p>\n<ul>\n  <li>Zwaarder gesuppresseerde cycles (lange duur, hoge dose, harde stacks).</li>\n  <li>PCT na <a href=\"/hcg\">HCG</a>-bridge.</li>\n  <li>Restart-protocollen voor mannen met blijvende post-cycle hypogonadisme.</li>\n</ul>\n\n<p><strong>Niet kiezen als:</strong></p>\n<ul>\n  <li>Je gevoelig bent voor depressie/stemming.</li>\n  <li>Je een baan hebt waar visuele helderheid kritiek is (piloot, chirurg, etc).</li>\n  <li>Je een mild cycle hebt waar <a href=\"/nolvadex\">Nolva</a> solo voldoet.</li>\n  <li>Je een hoge mentale eisen-periode hebt (deadlines, examens — Clomid mist je hoofd).</li>\n</ul>\n\n<p>Switch naar enclomifeen of pure Nolva als bijwerkingen ondraaglijk zijn.</p>",
      },
    ],
    faqs: [
      {
  ...
  },
  {
    ...
    heroImage: "/img/stof/arimidex-hero.jpg",
    heroImageAlt: "Macro foto van een klein bottle voor de stof-pagina arimidex",
    resultImage: "/img/stof/arimidex-resultaat.webp",
    ...
    sections: [
      {
        ...
        body: "<p>Anastrozol bindt reversibel aan de aromatase-enzyme — competitief, dus het kan loslaten wanneer concentratie zakt. Daardoor wordt minder testosteron omgezet in oestradiol (E2).</p>\n\n<p>Effect is snel: binnen 24-48 uur zie je E2 zakken. Reversibel betekent ook dat als je een dosis overslaat, aromatase weer aanslaat en E2 binnen 1-2 dagen oploopt. Vandaar dat veel gasten E3D doseren in plaats van dagelijks.</p>\n\n<p>Effect op E2 is dose-dependent:</p>\n\n<ul>\n  <li>0.25 mg E3D zakt E2 met 30-40%.</li>\n  <li>0.5 mg dagelijks tot 70%.</li>\n</ul>\n\n<ul>\n  <li>Dose te hoog = E2 crash, alle ellende van te lage E2.</li>\n  <li>Te laag = gyno-risico en vochtretentie.</li>\n</ul>\n\n<p>Sweet spot zoeken via bloedwerk.</p>",
      },
      {
        heading: "Doseringen en cycle-protocol",
        body: "<p>Start met een lage dose op basis van je cycle.</p>\n\n<ul>\n  <li>500 mg <a href=\"/testosteron\">Test</a> alleen: meestal is 0.25 mg E3D voldoende.</li>\n  <li>750 mg Test of een stack met <a href=\"/dianabol\">Dbol</a>: 0.5 mg E3D kan nodig zijn.</li>\n</ul>\n\n<p>Doe eerste bloedwerk op week 4-6 — E2 sensitive assay (NIET de standaard, vraag specifiek 'oestradiol sensitief LC-MS/MS').</p>\n\n<p>Doel: E2 tussen 20-35 pg/mL.</p>\n\n<ul>\n  <li>Boven 45: dose verhogen of frequenter.</li>\n  <li>Onder 20: dose verlagen of overslaan.</li>\n</ul>\n\n<p>Een week na aanpassing weer bloedwerk.</p>\n\n<p>Voor anti-gyno on-cycle: arimidex is preventief. Voor actieve gyno-knobbel start je beter met <a href=\"/nolvadex\">Nolva</a> 20 mg/dag (snellere receptor-blockade).</p>\n\n<p><strong>PCT-fase:</strong> GEEN Arimidex meer, want PCT heeft E2 nodig voor LH-feedback.</p>",
      },
      {
        heading: "Risico's en bijwerkingen",
        body: "<p><strong>Te hoge dose is het grootste risico.</strong> E2 crash geeft:</p>\n\n<ul>\n  <li>libido-verlies;</li>\n  <li>erectile dysfunction;</li>\n  <li>droge knarsende gewrichten (vooral bij compounds);</li>\n  <li>depressie/mentale flat;</li>\n  <li>vermoeidheid;</li>\n  <li>slechtere pumps;</li>\n  <li>HDL-cholesterol daalt.</li>\n</ul>\n\n<p>Lipiden-impact: LDL kan licht stijgen. Bot-mineraal-densiteit daalt bij langdurig hoge dose (relevant bij maanden TRT-gebruik). Lever-enzymen meestal stabiel.</p>\n\n<p>Bij vrouwen (zeldzaam gebruik):</p>\n\n<ul>\n  <li>brandende opvliegers;</li>\n  <li>stemmingsdips.</li>\n</ul>\n\n<p><strong>Belangrijk:</strong> bij gevoeligheid voor stemming kies Aromasin in plaats van Arimidex. Aromasin geeft milder mentaal profiel volgens veel ervaringen.</p>\n\n<p><strong>Stop NOOIT abrupt op hoge dose</strong> — rebound oestrogeen kan acute gyno triggeren. Bouw af in stappen.</p>",
      },
      {
        heading: "Onderzoek en bronnen",
        body: "<p>Arimidex (anastrozol) is sinds 1995 op de markt voor borstkanker bij postmenopauzale vrouwen. Er zijn veel klinische data.</p>\n\n<ul>\n  <li>Voor effect op test/E2-ratio bij mannen: Mauras et al., 2009 over anastrozol-effect bij hypogonadale mannen.</li>\n  <li>Voor de E2-sweet-spot studie bij mannen: Finkelstein et al., NEJM 2013 — landmark studie die laat zien dat zowel te laag als te hoog E2 schadelijk is.</li>\n  <li>Voor lange-termijn AI-gebruik en botdensiteit: Eastell et al., 2008.</li>\n</ul>\n\n<p>Arimidex is een geregistreerd geneesmiddel. De kwaliteit van de pharma-versie is hoog.</p>\n\n<p>UGL/research-chem versies kunnen wisselen — vraag HPLC bij twijfel.</p>",
      },
      {
        heading: "Wanneer wel/niet kiezen",
        body: "<p><strong>Wel kiezen voor:</strong></p>\n<ul>\n  <li>cycles met aromatiseerbare compounds (<a href=\"/testosteron\">test</a>, <a href=\"/dianabol\">dbol</a>, Sustanon, EQ in hogere doses);</li>\n  <li>gyno-prevention bij wie aanleg heeft;</li>\n  <li>mannen op TRT met chronisch verhoogd E2.</li>\n</ul>\n\n<p><strong>Niet kiezen als:</strong></p>\n<ul>\n  <li>je een non-aromatiseerbare cycle hebt (tren only, primobolan only, anavar/winstrol);</li>\n  <li>je in PCT-fase zit (E2-suppressie tegenwerkt LH-restart);</li>\n  <li>je libido al laag is door andere oorzaken (eerst dat oplossen voordat je AI toevoegt);</li>\n  <li>je geen toegang tot E2-bloedwerk hebt (blind doseren is een gok).</li>\n</ul>\n\n<p>Voor wie milder mentaal profiel wil: kies Aromasin (exemestane) als alternatief.</p>",
      },
    ],
    faqs: [
      {
    ...
    sections: [
      {
        ...
        body: "<p>HCG is een glycoproteine dat door de placenta wordt geproduceerd tijdens zwangerschap. Het houdt het corpus luteum actief in vrouwen.</p>\n\n<p>Bij mannen werkt HCG op de LH-receptor op Leydig-cellen in de testes. De binding is identiek aan LH, dus de cellen denken dat hypofyse-LH binnenkomt en blijven <a href=\"/testosteron\">testosteron</a> produceren.</p>\n\n<p>Tijdens een anabolenkuur is exogeen testosteron hoog. De hypothalamus stopt GnRH, de hypofyse stopt LH en Leydig-cellen krijgen geen signaal meer. Ze stoppen met werken en de testes krimpen binnen 4-6 weken.</p>\n\n<p>HCG vervangt de LH-signal en houdt de machinerie draaiend.</p>\n\n<p><strong>Belangrijk:</strong> HCG werkt op de testes, NIET op hypothalamus/hypofyse. Je herstart je hypofyse niet; dat blijft het werk van SERMs in PCT.</p>",
      },
      {
        heading: "Doseringen en cycle-protocol",
        body: "<p>Er zijn twee benaderingen.</p>\n\n<p><strong>Klassiek 'on-cycle':</strong> vanaf week 3-4 250 IE 2x per week (maandag/donderdag) tot 2 weken voor PCT.</p>\n\n<ul>\n  <li>Houdt testes op formaat.</li>\n  <li>Voorkomt atrofie.</li>\n  <li>Vlot HPTA-herstel.</li>\n</ul>\n\n<p><strong>Modern:</strong> 'blast-cruise gasten' nemen 500 IE 2x per week continu op TRT-base.</p>\n\n<p><strong>Voor vóór-PCT 'bridge':</strong> 1000-2500 IE EOD voor 10-14 dagen, daarna SERMs starten.</p>\n\n<p>Doel: testes wakker maken voor de SERM-trigger.</p>\n\n<p><strong>Niet overdoseren:</strong> boven 1500 IE per shot wordt aromatase in de testes geactiveerd en E2 schiet omhoog.</p>\n\n<p>Eindigt 5-7 dagen vóór SERM-PCT start.</p>\n\n<p><strong>Mengen:</strong> HCG komt als poeder + waterampul, mengen, kort houdbaar in koelkast (2-4 weken).</p>",
      },
      {
        heading: "Risico's en bijwerkingen",
        body: "<p>Bij correcte dose: minimaal.</p>\n\n<p>Het belangrijkste risico is overdoseren. Boven 1000 IE per shot stijgt E2 vaak fors (HCG triggert aromatase in testes), wat gyno of vochtretentie kan geven.</p>\n\n<p>Vandaar dat on-cycle <strong>250 IE 2x per week</strong> ideaal is.</p>\n\n<p>Lange-termijn hoge dose (&gt;3000 IE per week voor maanden): Leydig-cellen kunnen 'desensitiseren' voor LH/HCG (downregulation) — minder respons op later HCG of natural LH.</p>\n\n<p>Daarom HCG nooit jaren onafgebroken op hoge dose.</p>\n\n<ul>\n  <li>Locale reactie bij injectie mogelijk (rood plekje, niet ernstig).</li>\n  <li>Hoofdpijn bij hogere doses.</li>\n  <li>Kan vermoeidheid geven bij sommige gasten.</li>\n  <li>Geen lever-belasting, geen significante lipiden-impact bij standaard dose.</li>\n</ul>",
      },
      {
        heading: "Onderzoek en bronnen",
        body: "<p>HCG-gebruik bij mannen is uitgebreid onderzocht in vruchtbaarheids-context.</p>\n\n<ul>\n  <li>Voor on-cycle HCG om testikulair volume te behouden: Coviello et al., 2005 over LH-mimetiek bij androgeen-suppressie.</li>\n  <li>Voor HCG bij hypogonadale mannen en spermatogenese-behoud: Liu et al., 2005.</li>\n  <li>Voor de relatie tussen HCG-dose en E2-stijging: Hsieh et al., 2013 over HCG-effect op intratesticulaire E2.</li>\n</ul>\n\n<p>HCG-producten als Pregnyl (Organon) en Ovitrelle (recombinant) zijn pharma-grade — UGL-HCG is er ook, kwaliteit wisselt.</p>\n\n<p><strong>Pharma-grade altijd voorkeur voor dit specifieke peptide.</strong></p>",
      },
      {
        heading: "Wanneer wel/niet kiezen",
        body: "<p><strong>Wel gebruiken voor:</strong></p>\n<ul>\n  <li>lange cycles (12+ weken);</li>\n  <li>zware stacks waar onderdrukking van je eigen testosteron-productie diep gaat;</li>\n  <li>mannen die vruchtbaar willen blijven (spermatogenese-behoud);</li>\n  <li>blast-cruise gasten die op TRT-cruise testikulair volume willen behouden.</li>\n</ul>\n\n<p><strong>Niet gebruiken als:</strong></p>\n<ul>\n  <li>het je eerste of tweede korte cycle is (10 weken test only herstelt vaak ook zonder HCG);</li>\n  <li>je een korte oral-only cycle hebt;</li>\n  <li>je een geschiedenis hebt van hCG-allergie.</li>\n</ul>\n\n<p>Niet vervangen voor SERM-PCT — HCG is alleen testikulair, SERMs (<a href=\"/nolvadex\">Nolva</a>, <a href=\"/clomid\">Clomid</a>) zijn voor hypofyse-as.</p>",
      },
    ],
    faqs: [
      {
...
export const mainCategories: MainCategory[] = [
  {
    ...
    image: "/img/category/injectie-hero.webp",
    to: "/winkel/injectie",
  },
  {
    ...
    image: "/img/category/pillen-tabletten-hero.webp",
  ...
  },
  {
    ...
    image: "/img/category/kuurpakketten-hero.webp",
  ...
  },
  {
    ...
    image: "/img/category/nakuur-hero.webp",
    to: "/winkel/nakuur",
  },
  {
    slug: "afvallen",
    ...
    image: "/img/category/afvallen-hero.webp",
    to: "/winkel/afvallen",
  },
  {
    ...
    image: "/img/category/erectiemiddelen-hero.webp",
  ...
  },
  {
    ...
    image: "/img/category/hgh-hero.jpg",
    to: "/winkel/hgh",
  },
  {
    slug: "peptides",
    ...
    image: "/img/category/peptides-hero.jpg",
    to: "/winkel/peptides",
  },
];
